...
static const uint8_t vcom_configuration_descriptor_data[67] = {
  ...
  USB_DESC_CONFIGURATION(67,            /* wTotalLength.                  配置描述符集合的长度    */
                         0x02,          /* bNumInterfaces.                支持的接口数量  */
                         0x01,          /* bConfigurationValue.            该配置的值，跟设置接口有关 */
                         0,             /* iConfiguration.                  */
                         0xC0,          /* bmAttributes (self powered).    自供电 */
                         50),           /* bMaxPower (100mA).              供电电流 */
  /* Interface Descriptor.*/
  USB_DESC_INTERFACE    (0x00,          /* bInterfaceNumber.               接口号，0 */
                         0x00,          /* bAlternateSetting.               */
                         0x01,          /* bNumEndpoints.                  端点0之外的端点，1号 */
