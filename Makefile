...
# Startup files.
include $(CHIBIOS)/os/common/startup/ARMCMx/compilers/GCC/mk/startup_gd32e507.mk
# HAL-OSAL files (optional).
include $(CHIBIOS)/os/hal/hal.mk
include $(CHIBIOS)/gd32e507/platform.mk 
# include $(CHIBIOS)/os/hal/ports/STM32/STM32L5xx/platform.mk
include $(CHIBIOS)/gd32e507/board/board.mk
include $(CHIBIOS)/os/hal/osal/rt-nil/osal.mk
# RTOS files (optional).
include $(CHIBIOS)/os/rt/rt.mk
include $(CHIBIOS)/os/common/ports/ARMv8-M-ML/compilers/GCC/mk/port.mk
include $(CHIBIOS)/GD32E50x_standard_peripheral/gdlib.mk
...
LDSCRIPT= $(STARTUPLD)/GD32E507R.ld
