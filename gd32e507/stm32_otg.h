 ...
 */
typedef struct {
  volatile uint32_t HCCHAR;     //HCHCTL    /**< @brief Host channel characteristics register.                       */
  volatile uint32_t resvd8;     //HCHSTCTL    
  volatile uint32_t HCINT;      //HCHINTF   /**< @brief Host channel interrupt register.*/
  volatile uint32_t HCINTMSK;   //HCHINTEN  /**< @brief Host channel interrupt mask register.                       */
  volatile uint32_t HCTSIZ;     //HCHLEN    /**< @brief Host channel transfer size register.                       */
  volatile uint32_t resvd14;    //HCHDMAADDR
 ...
 */
typedef struct {
  volatile uint32_t DIEPCTL;    //DIEPCTL /**< @brief Device control IN endpoint control register.               */
  volatile uint32_t resvd4;
  volatile uint32_t DIEPINT;    //DIEPINTF  /**< @brief Device IN endpoint interrupt register.                       */
  volatile uint32_t resvdC;
  volatile uint32_t DIEPTSIZ;   //DIEPLEN /**< @brief Device IN endpoint transfer size register.                       */
  volatile uint32_t resvd14;    //DIEPDMAADDR
  volatile uint32_t DTXFSTS;    //DIEPTFSTAT  /**< @brief Device IN endpoint transmit FIFO status register.                */
  volatile uint32_t resvd1C;
} stm32_otg_in_ep_t;
 ...
 */
typedef struct {
  volatile uint32_t DOEPCTL;    //DOEPCTL /**< @brief Device control OUT endpoint control register.               */
  volatile uint32_t resvd4;
  volatile uint32_t DOEPINT;    //DOEPINTF  /**< @brief Device OUT endpoint interrupt register.                       */
  volatile uint32_t resvdC;
  volatile uint32_t DOEPTSIZ;   //DOEPLEN /**< @brief Device OUT endpoint transfer size register.                  */
  volatile uint32_t resvd14;    //DOEPDMAADDR
  volatile uint32_t resvd18;
  volatile uint32_t resvd1C;
} stm32_otg_out_ep_t;
 ...
 */
typedef struct {
  volatile uint32_t GOTGCTL;    //GOTGCS    /**< @brief OTG control and status register.*/
  volatile uint32_t GOTGINT;    //GOTGINTF  /**< @brief OTG interrupt register.         */
  volatile uint32_t GAHBCFG;    //GAHBCS    /**< @brief AHB configuration register.     */
  volatile uint32_t GUSBCFG;    //GUSBCS    /**< @brief USB configuration register.     */
  volatile uint32_t GRSTCTL;    //GRSTCTL   /**< @brief Reset register size.            */
  volatile uint32_t GINTSTS;    //GINTF     /**< @brief Interrupt register.             */
  volatile uint32_t GINTMSK;    //GINTEN    /**< @brief Interrupt mask register.        */
  volatile uint32_t GRXSTSR;    //GRSTATR   /**< @brief Receive status debug read register.                       */
  
  volatile uint32_t GRXSTSP;    //GRSTATP   /**< @brief Receive status read/pop register.                       */
  volatile uint32_t GRXFSIZ;    //GRFLEN    /**< @brief Receive FIFO size register.     */
  volatile uint32_t DIEPTXF0;   //DIEP0TFLEN_HNPTFLEN   /**< @brief Endpoint 0 transmit FIFO size register.                       */
  volatile uint32_t HNPTXSTS;   //HNPTFQSTAT  /**< @brief Non-periodic transmit FIFO/queue status register.                */
  volatile uint32_t resvd30;
  volatile uint32_t resvd34;
  volatile uint32_t GCCFG;      //GCCFG     /**< @brief General core configuration.     */
  volatile uint32_t CID;        //CID       /**< @brief Core ID register.               */
  volatile uint32_t resvd58[48];
  volatile uint32_t HPTXFSIZ;   //HPTFLEN   /**< @brief Host periodic transmit FIFO size register.                       */
  volatile uint32_t DIEPTXF[15];//DIEPTFLEN /**< @brief Device IN endpoint transmit FIFO size registers.                 */
  volatile uint32_t resvd140[176];
  volatile uint32_t HCFG;       //HCTL    /**< @brief Host configuration register.    */
  volatile uint32_t HFIR;       //HFT     /**< @brief Host frame interval register.   */
  volatile uint32_t HFNUM;      //HFINFR  /**< @brief Host frame number/frame time Remaining register.             */
  volatile uint32_t resvd40C;
  volatile uint32_t HPTXSTS;    //HPTFQSTAT /**< @brief Host periodic transmit FIFO/queue status register.                */
  volatile uint32_t HAINT;      //HACHINT   /**< @brief Host all channels interrupt register.                       */
  volatile uint32_t HAINTMSK;   //HACHINTEN /**< @brief Host all channels interrupt mask register.                       */
  volatile uint32_t resvd41C[9];
  volatile uint32_t HPRT;       //HPCS      /**< @brief Host port control and status register.                       */
  volatile uint32_t resvd444[47];
  stm32_otg_host_chn_t hc[16];  /**< @brief Host channels array.            */
  volatile uint32_t resvd700[64];
  volatile uint32_t DCFG;       //DCFG  /**< @brief Device configuration register.  */
  volatile uint32_t DCTL;       //DCTL  /**< @brief Device control register.        */
  volatile uint32_t DSTS;       //DSTAT /**< @brief Device status register.         */
  volatile uint32_t resvd80C;
  volatile uint32_t DIEPMSK;    //DIEPINTEN /**< @brief Device IN endpoint common interrupt mask register.        */
  volatile uint32_t DOEPMSK;    //DOEPINTEN /**< @brief Device OUT endpoint common interrupt mask register.        */
  volatile uint32_t DAINT;      //DAEPINT   /**< @brief Device all endpoints interrupt register.                       */
  volatile uint32_t DAINTMSK;   //DAEPINTEN /**< @brief Device all endpoints interrupt mask register.                  */
  volatile uint32_t resvd820;
  volatile uint32_t resvd824;
  volatile uint32_t DVBUSDIS;   //DVBUSDT   /**< @brief Device VBUS discharge time register.                       */
  volatile uint32_t DVBUSPULSE; //DVBUSPT   /**< @brief Device VBUS pulsing time register.                       */
  volatile uint32_t resvd830;
  volatile uint32_t DIEPEMPMSK; //DIEPFEINTEN /**< @brief Device IN endpoint FIFO empty interrupt mask register.        */
  volatile uint32_t resvd838;   //DEP1INT
  volatile uint32_t resvd83C;   //DEP1INTEN
  ...
  volatile uint32_t PCGCCTL;    //PWRCLKCTL /**< @brief Power and clock gating control register.                       */
 ...
 * @{
 */
#define PCGCCTL_DSLEEP          (1U << 7)              /*!< PHY is in deep sleep status */
#define PCGCCTL_SSLEEP          (1U << 6)              /*!< PHY is in shallow sleep status */
#define PCGCCTL_SCGEN           (1U << 5)              /*!< When this bit is set, the internal clock gating is enabled */
